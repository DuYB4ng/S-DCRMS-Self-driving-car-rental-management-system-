...
const fakeReports = [
  { id: 1, title: "Có báo cáo mới từ chi nhánh quận 7", status: "2 giờ trước" },
  { id: 2, title: "Xe 66A-11111 cần bảo trì gấp", status: "5 phút trước" },
];
      ...
      <div className="reports-page">
        <div className="reports-card">
          <div className="reports-card__header">
            <h1>Thông báo</h1>
            <button className="reports-card__button">
              + Tạo thông báo mới
            </button>
          </div>
          ...
          <table className="reports-table">
            <thead>
              <tr>
                <th>Tình trạng xe</th>
                <th>Thời gian xảy ra vụ việc</th>
              </tr>
            </thead>
            <tbody>
              {fakeReports.map((r) => (
                <tr key={r.id}>
                  ...
                  <td>
                    <span
                      className={
                        "status-chip " +
                        (r.status === "" ? "status-pending" : "status-done")
                      }
                    >
                      {r.status}
                    </span>
